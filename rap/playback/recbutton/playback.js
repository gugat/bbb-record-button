...
var RECORDINGS = "/recbutton/" + MEETINGID;
...
load_video = function(){
   ...
   video.setAttribute('src', RECORDINGS + '/video/webcam.webm');
   ...
   var pcWebcam = Popcorn("#webcam");
   time_manager.on( "timeupdate", function() {
   	pcWebcam.currentTime( this.currentTime() );
   });	
}  

load_deskshare = function(){
   console.log("Loading deskshare")
   var deskshare = document.createElement("video")   
   deskshare.setAttribute('src', RECORDINGS + '/video/deskshare.webm');
   deskshare.setAttribute('type','video/webm');
   deskshare.setAttribute('id','deskshare');  
   document.getElementById("deskshareRecordingWrapper").appendChild(deskshare);

   var time_manager = Popcorn("#video");
   var sharedDesktop = Popcorn("#deskshare");
   time_manager.on( "timeupdate", function() {
   	sharedDesktop.currentTime( this.currentTime() );
   });  
}  
...
document.addEventListener( "DOMContentLoaded", function() {
  ...
  load_audio();
  deskshare_exist = checkUrl(RECORDINGS + '/video/deskshare.webm')
  webcam_exist = checkUrl(RECORDINGS + '/video/webcam.webm')
  if ( deskshare_exist == true){
      load_deskshare();
  }else{
	document.getElementById("deskshareRecordingWrapper").style.display = "none";
  }
  if ( webcam_exist == true){
      load_video();
  }else{
	document.getElementById("videoRecordingWrapper").style.display = "none";
  }
  if (webcam_exist == false && deskshare_exist == false){
